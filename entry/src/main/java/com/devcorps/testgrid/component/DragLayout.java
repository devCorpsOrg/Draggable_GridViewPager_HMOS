...
import com.devcorps.testgrid.model.GridItemInfo;
...
public class DragLayout{
    // Item count
    private static final int UP_ITEM_COUNT = 23;
    ...
    private final Component.LongClickedListener longClickListener =
            component -> {
                ...
                // You can manipulate any dragging events in this section
    ...
    // Adding grid items according to the number of item count
    public void initUpListItem() {
        String itemText = AppUtils.getStringResource(slice, ResourceTable.String_grid_text);
    ...
    // Event Listener when user touches grid item
    ...
    private void handleScroll(int pointY) {
        ...
        if (pointY > currentDragY
                ...
                + scrollView.getScrollValue(Component.HORIZONTAL)
